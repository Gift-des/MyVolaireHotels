package com.example.myvolairehotels.ui.theme.screens.login
...
import com.example.myvolairehotels.data.AuthViewModel
import com.example.myvolairehotels.navigation.ROUT_REGISTER
import com.example.myvolairehotels.ui.theme.backgroundlogin
...
fun LoginScreen(navController: NavController){
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(value = email, onValueChange = {email=it},
            label = { Text(text="Enter your Email", fontSize = 20.sp) },
