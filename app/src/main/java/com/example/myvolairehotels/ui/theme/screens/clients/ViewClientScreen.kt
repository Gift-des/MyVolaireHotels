...
import com.example.myvolairehotels.models.Client
import com.example.myvolairehotels.navigation.ROUT_THANKYOU
import com.example.myvolairehotels.navigation.ROUT_UPDATECLIENT
...
@Composable
fun ViewClientScreen(navController: NavHostController, id: String){
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Card(modifier = Modifier.size(350.dp,450.dp).padding(10.dp)) {
            ...
            Row {
                ...
                Button(onClick = {
                    navController.navigate(ROUT_UPDATECLIENT +"/$id")
                }) {
                    Text(text = "Update", color = Color.Green)
                }
                Spacer(modifier = Modifier.width(10.dp))
                Button(onClick = {
                    navController.navigate(ROUT_THANKYOU)
                }) {
