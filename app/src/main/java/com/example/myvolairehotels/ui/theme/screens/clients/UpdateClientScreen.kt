...
@Composable
fun UpdateClientScreen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        val currentDataRef = FirebaseDatabase.getInstance().getReference().child("Client/$idnumber")
...
fun UpdateClientScreenPreview() {
    UpdateClientScreen(navController = rememberNavController())
}